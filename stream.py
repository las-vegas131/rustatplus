...
def export_matches_advanced(matches_dict, selected_match_ids, team_name, season_year, league_avg, player_season_map, output_bytes_io):
    # ... (весь предыдущий код до создания заголовков)
    ...
    for col_idx, header in enumerate(headers, start=1):
        ...
        cell.alignment = Alignment(horizontal='center', vertical='center', textRotation=255)  # 255 = вертикальный текст
        # Задаём ширину колонок (узкую, как в примере)
        ws.column_dimensions[get_column_letter(col_idx)].width = 6  # для всех колонок, кроме первых трёх?
        # Но в вашем примере ширина разная. Лучше задать список, как ранее.
        # Для вертикальных заголовков ширина 6-8 достаточна.
    # После установки ширины нужно также установить высоту строки заголовка, чтобы текст поместился
